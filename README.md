...
[![GitHub](https://img.shields.io/badge/GitHub-siddhantmishra--4098-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/siddhantmishra-4098)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-siddhant700-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/siddhant700/)
[![Email](https://img.shields.io/badge/Email-mishrasiddhant911%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mishrasiddhant911@gmail.com)

<img src="https://media.giphy.com/media/pMujWgoqyPxTRHgFKG/giphy.gif" width="320" alt="Invincible - Amazon Prime Video"/>
...
![lifelines](https://img.shields.io/badge/lifelines-survival--analysis-4B8BBE?style=flat-square)
![Apache Spark](https://img.shields.io/badge/Apache%20Spark-E25A1C?style=flat-square&logo=apachespark&logoColor=white)
![CmdStanPy](https://img.shields.io/badge/CmdStanPy%20%2F%20ArviZ-Bayesian%20Stats-B2001D?style=flat-square)
...
![Ultralytics YOLOv8](https://img.shields.io/badge/Ultralytics%20YOLOv8-111F68?style=flat-square)
...
![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=flat-square)
![scikit-learn](https://img.shields.io/badge/scikit--learn-F7931E?style=flat-square&logo=scikitlearn&logoColor=white)
![lifelines](https://img.shields.io/badge/lifelines-4B8BBE?style=flat-square)
![Gradio](https://img.shields.io/badge/Gradio-F97316?style=flat-square&logo=gradio&logoColor=white)
![Hugging Face](https://img.shields.io/badge/Hugging%20Face-FFD21E?style=flat-square&logo=huggingface&logoColor=black)
...
<div align="center">
<img src="https://media.giphy.com/media/FKHZLjnz4c2ly/giphy.gif" width="260" alt="Pickle Rick - Adult Swim"/>
...
#### [ABDA](https://github.com/siddhantmishra-4098/ABDA)
A TU Dortmund University Bayesian statistics project comparing four **Stan**-implemented regression models (Student-t, two-regime mixture, hurdle-lognormal, hierarchical) for modeling public-transport departure delays, fit via **CmdStanPy** and compared using PSIS-LOO. Co-authored, with a full written report included.

![Stan](https://img.shields.io/badge/Stan-B2001D?style=flat-square)
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![Jupyter](https://img.shields.io/badge/Jupyter-F37626?style=flat-square&logo=jupyter&logoColor=white)
![CmdStanPy / ArviZ](https://img.shields.io/badge/CmdStanPy%20%2F%20ArviZ-Bayesian-B2001D?style=flat-square)

#### [funnel_analysis](https://github.com/siddhantmishra-4098/funnel_analysis)
A marketing funnel and cohort analysis on Google's public **GA4 e-commerce** sample dataset. **BigQuery SQL** handles first-touch attribution and sequential funnel construction; Python notebooks cover conversion-rate and cohort analysis; a small **Streamlit** dashboard surfaces the results.
...
#### [Social-Network-Analysis](https://github.com/siddhantmishra-4098/Social-Network-Analysis)
A graph-theory exercise in **R** using `igraph`: builds directed/undirected networks, computes degree / closeness / betweenness centrality and reciprocity, runs HITS (hub & authority scores), and performs edge-betweenness community detection on a sample social network.
...
#### [Tire-State-Analyzer](https://github.com/siddhantmishra-4098/Tire-State-Analyzer)
A lighter-weight tire-condition classifier: a **Keras/TensorFlow** CNN served through Streamlit that labels an uploaded tire photo as inflated, deflated, or "no tire," linking out to the deeper Tire-And-Damage segmentation tool for follow-up.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![TensorFlow](https://img.shields.io/badge/TensorFlow-FF6F00?style=flat-square&logo=tensorflow&logoColor=white)
![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=white)

#### [Smoke-Detector](https://github.com/siddhantmishra-4098/Smoke-Detector)
A real-time smoke-segmentation app: a **TensorFlow/Keras** binary-segmentation model runs on a live webcam/WebRTC video stream (via `streamlit-webrtc` + OpenCV), overlaying detected smoke regions and a live smoke-coverage percentage on each frame. [Live demo →](https://smokedetector.streamlit.app/)
...
#### [Airbag](https://github.com/siddhantmishra-4098/Airbag)
A Streamlit app that trains a **scikit-learn** Logistic Regression model on an airbag-recommendation dataset (car weight, impact force, deceleration time, etc.) and recommends an airbag configuration from user-entered crash parameters.
...
#### [Doodle-to-Image](https://github.com/siddhantmishra-4098/Doodle-to-Image)
A doodle-to-photorealistic-image generator built on **SPADE** semantic image synthesis, with a Streamlit canvas (`streamlit-drawable-canvas`) for freehand sketching by label (sea, mountain, tree, etc.) and a **PyTorch** GAN generator fetched on demand.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![PyTorch](https://img.shields.io/badge/PyTorch-EE4C2C?style=flat-square&logo=pytorch&logoColor=white)
![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=white)
![GAN / SPADE](https://img.shields.io/badge/GAN%20%2F%20SPADE-image--synthesis-EE4C2C?style=flat-square)

<div align="center">
<img src="https://media.giphy.com/media/pMujWgoqyPxTRHgFKG/giphy.gif" width="260" alt="Invincible - Amazon Prime Video"/>
...
![Power Query M](https://img.shields.io/badge/Power%20Query%20(M)-F2C811?style=flat-square)

#### [Accident-Dashbord-for-years-2019-2022-Using-Tableau](https://github.com/siddhantmishra-4098/Accident-Dashbord-for-years-2019-2022-Using-Tableau)
A **Tableau** dashboard classifying road-accident records from 2019–2022 by severity (slight to fatal), published to Tableau Public.

![Tableau](https://img.shields.io/badge/Tableau-E97627?style=flat-square&logo=tableau&logoColor=white)

#### [Accident_Dashbord](https://github.com/siddhantmishra-4098/Accident_Dashbord)
A **Streamlit** dashboard over an India road-accidents dataset with state/city/fatality/injury filters and Plotly/Matplotlib/Seaborn visualizations, including a fatalities-vs-injuries scatter plot and a fatality-distribution histogram.
...
#### [CN-Port](https://github.com/siddhantmishra-4098/CN-Port)
A personal resume/portfolio site built on the "MyResume" Bootstrap template, customized with bio, resume, and social links.
...
#### [YouTube](https://github.com/siddhantmishra-4098/YouTube)
A front-end-only YouTube homepage clone (header, sidebar, video grid) built with plain HTML/CSS as an intro-to-HTML exercise.
...
#### [SplitWise_demo](https://github.com/siddhantmishra-4098/SplitWise_demo)
A **C++** implementation of the Splitwise debt-simplification algorithm: nets everyone's balance from a list of transactions, then greedily matches the largest debtor against the largest creditor to minimize the number of settling transactions.
